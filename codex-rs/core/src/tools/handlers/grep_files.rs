...
use crate::triseek::SearchOutcome;
...
impl ToolHandler for GrepFilesHandler {
    ...
    async fn handle(&self, invocation: ToolInvocation) -> Result<Self::Output, FunctionCallError> {
        ...
        let search_results = match crate::triseek::maybe_search_matching_files(
            turn.config.as_ref(),
            pattern,
            include.as_deref(),
            &search_path,
